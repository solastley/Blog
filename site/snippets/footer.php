          ...
          <div class="row">
              <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                  <ul class="list-inline text-center">
                      <li>
                          <a href="https://twitter.com/SolomonAstley" target="_blank">
                      ...
                      <li>
                          <a href="https://www.facebook.com/solomon.astley" target="_blank">
                              <span class="fa-stack fa-lg">
                                  <i class="fa fa-circle fa-stack-2x"></i>
                      ...
                      <li>
                          <a href="https://github.com/solastley" target="_blank">
                              <span class="fa-stack fa-lg">
                                  <i class="fa fa-circle fa-stack-2x"></i>
                  ...
                  <p class="copyright text-muted">Copyright &copy; Solomon Astley 2016</p>
              </div>
          </div>
      </div>
  </footer>
